...
export default function Company() {
  return (
    <div className="bg-neutral-100 p-8 py-28 px-28 flex justify-between">
      <div className="flex flex-col">
        <p className="text-5xl font-bold text-zinc-800">Why become a</p>
        <p className="text-5xl font-bold text-zinc-800">creator?</p>
        <p className="text-xl text-zinc-800 mt-6 text-pretty md:w-[600px]">
      ...
      <div className="flex flex-col space-y-28">
        <div className="flex">
          <div className="flex flex-col space-y-4 md:w-[330px]">
